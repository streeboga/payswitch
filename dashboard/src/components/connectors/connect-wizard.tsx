...
const CONNECTOR_TYPES: ConnectorTypeOption[] = [
  ...
  },
  {
    name: 'yookassa',
    label: 'YooKassa',
    descriptionKey: 'connectWizard.yookassaDesc',
    icon: DollarSign,
  },
  {
    name: 'sberbank',
    label: 'Сбербанк',
    descriptionKey: 'connectWizard.sberbankDesc',
    icon: Landmark,
  },
  {
    name: 'alfabank',
    label: 'Альфа-Банк',
    descriptionKey: 'connectWizard.alfabankDesc',
    icon: Landmark,
  },
  {
    name: 'tbank',
    label: 'Т-Банк',
    descriptionKey: 'connectWizard.tbankDesc',
    icon: Landmark,
  },
  {
    name: 'robokassa',
    label: 'Робокасса',
    descriptionKey: 'connectWizard.robokassaDesc',
    icon: ShoppingCart,
  },
  {
    name: 'tochka',
    label: 'Точка',
    descriptionKey: 'connectWizard.tochkaDesc',
    icon: CircleDot,
  },
  {
    name: 'test',
